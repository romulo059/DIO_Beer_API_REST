...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Antonio Sergio Jr";
    private static final String CONTACT_GITHUB = "https://gtihub.com/antoniosergiojr";
    private static final String CONTACT_EMAIL = "sergio.gxp@gmail.com"; 
